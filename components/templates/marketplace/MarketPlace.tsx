    ...
    return (
        ...
        <div className="justify-center px-4 py-16 mx-auto  sm:px-4 sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-8">
          ...
          <div className="max-w-screen-sm sm:text-center sm:mx-auto">
            ...
            <h2 className="m-auto pb-8 text-2xl text-center font-semibold tracking-wide text-yellow-100 sm:text-4xl sm:leading-none sm:m-auto font-Cinzel py-3">
       Sky Godz Marketplace
            </h2>
            <hr className="w-full  border-yellow-200" />
            <p className="text-base text-white text-center lg:text-xl md:text-lg sm:px-4 py-5 font-Proza Libre">
